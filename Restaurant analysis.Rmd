...
```
The weekly check out price of all centers is not staple, there are weeks of high income and others with low income. The average weekly income is 4512 with standard error of the mean 976.9. The lower confidence interval is 2597, and upper confidence interval is 6427. 
...
```
There are 1999 centers. The maximum number of orders is 3605 and the lowest is 13 orders.
